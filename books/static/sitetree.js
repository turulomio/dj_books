(function(e, t, n, r) {
  ...
  o.prototype.init = function() {
    ...
    t.$allBranches.each(function() {
      ...
      if (n.size() > 0) {
        ...
        e(
          '<span class="icon ' + t.options.collapsedIconClass + '"></span>'
        ).prependTo(e(this));
      }
    });
  ...
  o.prototype.expand = function(e) {
    ...
    e
      ...
      .show(500, function() {
        ...
        e
          .children("span.icon")
          .removeClass(t.options.collapsedIconClass)
          .addClass(t.options.expandedIconClass);
      });
  };
  o.prototype.collapse = function(e) {
    ...
    e
      ...
      .hide(500, function() {
        ...
        e
          .children("span.icon")
          .removeClass(t.options.expandedIconClass)
          .addClass(t.options.collapsedIconClass);
      });
  };
  o.prototype.collapseAll = function() {
    ...
    e.$allBranches.not(e.$topLevelBranches).hide(1e3, function() {
      ...
      e.$allBranches
        .children("span.icon")
        .removeClass(e.options.expandedIconClass)
        .addClass(e.options.collapsedIconClass);
    });
  };
  o.prototype.expandAll = function() {
    ...
    e.$allBranches.show(1e3, function() {
      ...
      e.$allBranches
        .children("span.icon")
        .removeClass(e.options.collapsedIconClass)
        .addClass(e.options.expandedIconClass);
    });
  };
  e.fn[i] = function(t) {
...
$(document).ready(function() {
  $(".sitetree_menu ul:first").abixTreeList();
});
